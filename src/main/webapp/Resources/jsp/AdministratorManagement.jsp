...
<body>
	<div class="com-top">
		...
		<div class="admin-functionArea" style="padding-bottom:10px;">
	...
	<div class="content" id='content'>
		<table class="table table-striped table-hover" id="table-content">
			...
			<tbody>
				<tr v-for="admin in adminList">
					...
					<td><button class='btn btn-primary com-alert' v-bind:value="admin.id" data-toggle='modal' data-target='#admin-update' id='admin-update-button' v-if="admin.permission==0">修改权限</button>
		...
		<div class="com-total" id="admin-total">共有{{allAdminCount}}条信息</div>
		<!-- 分页功能 -->
		<div class="pageNav">
			<ul class="pagination">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" id="admin-add-form" method="post">
						<div>
							<label for="admin-name" style="width:100px;">账号:</label><input type="text"
								name="user" id="admin-name">
						</div>
						<div>
							<label for="admin-password" style="width:100px;">密码:</label><input type="password"
								name="password" id="admin-password">
						</div>
						<div>
							<label for="admin-sex" style="width:100px;">权限:</label> 
							<!-- <select id="admin-permission" name="permission">
								<option value="">---请选择---</option>
								<option value="0">普通管理员</option>
								<option value="1">超级管理员</option>
							</select> -->
							<input type="checkbox" name="permission" value="1" @click="changePer_1()"/>分类管理
							<input type="checkbox" name="permission" value="2" @click="changePer_1()"/>商品管理
							<input type="checkbox" name="permission" value="3" @click="changePer_1()"/>订单管理
							<input type="checkbox" name="permission" value="4" @click="changePer_1()"/>用户管理
						</div>
						<input type="hidden" id="admin-per" name="data" value="" />
					</form>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" id="admin-update-form" method="post">
						<div>
							<label for="admin-id" style="width:100px;">管理员ID:</label><input type="text" name="id"
						...
						<div>
							<label for="admin-sex" style="width:100px;">权限:</label> <!-- <select
								id="admin-permission" name="permission">
								<option value="">---请选择---</option>
								<option value="0">普通管理员</option>
								<option value="1">超级管理员</option>
							</select> -->
							<input type="checkbox" name="permission" value="1" @click="changePer_2()"/>分类管理
							<input type="checkbox" name="permission" value="2" @click="changePer_2()"/>商品管理
							<input type="checkbox" name="permission" value="3" @click="changePer_2()"/>订单管理
							<input type="checkbox" name="permission" value="4" @click="changePer_2()"/>用户管理
						</div>
						<input type="hidden" id="admin-per" name="data" value="" />
					</form>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" id="admin-update-password-form" method="post">
						...
						<div>
							<label for="admin-password" style="width:100px;">密码:</label><input type="password" name="password" id="admin-password"> 
						</div>
						<div><label for="admin-password-confirm" style="width:100px;">确认密码:</label><input type="password" name="password-confirm" id="admin-password-confirm"></div>
					</form>
